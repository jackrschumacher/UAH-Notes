# Security Auditing and System Hardening
			...
			- For example, using systemctl:
				...
				- Basic syntax:
					- ```bash
					  ...
					  ```
					- ![[image_1763430376613_0.png|Common systemctl commands]]
		...
		- **Best practices:**
			...
			- The ufw command
				...
				- ```bash
				  ufw [command] [options]
				  ```
		- ![[image_1763430920278_0.png|Common ufw rules]]
	- ## User Account Security
		...
		- The passwd command
			...
			- ```bash
			  ...
			  ```
		- ![[image_1763431207756_0.png|Common passwd commands]]
	- ## Filesystem Protections
		...
		- **Best Practices**
			...
			- ![[image_1763431427338_0.png|Automatic updates commands]]
	...
	- ### Threat Hunting Steps
		...
		3. Resolution
			...
			- [MITRE ATT&CK framework](https://attack.mitre.org)
				...
				- ![[attack_matrix_poster_2024_april-1_1763429016114_0.png|MITRE Enterprise framework (2024)]]
		- ![[image_1763424735993_0.png]]
		- ![[image_1763424746832_0.png]]
