...
- # 9.5- Strategy Formulation: Tools
	...
	- ### The BCG Growth-Share Matrix
		...
		- Usually have 4 characteristics
			1. Is a single business or collection of related business
			2. Has its own competitiors
			3. Manager who is accountable for its operation
			4. An area that can be independently planned for within the organization
		- Once they have been identified, use the BCG matric to categorize each SBU in one of the matrix quadrants
		- ![[image_1772070534032_0.png|398]]
