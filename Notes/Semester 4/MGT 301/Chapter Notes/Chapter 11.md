...
- ### Dividing Job Activities
	- Functional similarity method
		...
		2. Designate appropriate activities that must be performed
		3. Design specific jobs by grouping similar activities
		4. Make specific individuals responsible for performing the jobs
